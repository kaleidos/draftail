...
var DraftUtils = {
    ...
    getEntitySelection: function getEntitySelection(editorState, entityKey) {
        ...
        return selectionState.merge({
            anchorOffset: selectionState.isBackward ? entityRange.end : entityRange.start,
            focusOffset: selectionState.isBackward ? entityRange.start : entityRange.end
        });
    },
    ...
    handleHardNewline: function handleHardNewline(editorState) {
        ...
        if (!isListBlock && block.getType() !== BLOCK_TYPE.UNSTYLED && block.getLength() === selection.getStartOffset()) {
            ...
            if (depth === 0) {
                return draftJs.EditorState.push(editorState, draftJs.RichUtils.tryToRemoveBlockStyle(editorState), 'change-block-type');
            }
...
var isOptionKeyCommand = draftJs.KeyBindingUtil.isOptionKeyCommand;
...
var behavior = {
    ...
    blockStyleFn: function blockStyleFn(block) {
        ...
        return 'Draftail-block--' + type + ' ' + draftjsConductor.blockDepthStyleFn(block);
    },
...
var getComponentWrapper = function getComponentWrapper(Wrapped, wrapperProps) {
  var Wrapper = function Wrapper(props) {
    return React__default.createElement(Wrapped, _extends({}, props, wrapperProps));
  };
...
var Icon = function Icon(_ref) {
    ...
    if (isPathOrRef) {
        if (icon.includes('#')) {
            children = React__default.createElement('use', { xlinkHref: icon });
        } else {
            children = React__default.createElement('path', { d: icon });
        }
    } else if (Array.isArray(icon)) {
        // eslint-disable-next-line springload/react/no-array-index-key
        children = icon.map(function (d, i) {
            return React__default.createElement('path', { key: i, d: d });
        });
    } else {
        return icon;
    }
    ...
    createClass(ToolbarButton, [{
        ...
        value: function render() {
            ...
            return React__default.createElement(
                ...
                icon ? React__default.createElement(Icon, { icon: icon }) : null,
...
var ToolbarGroup = function ToolbarGroup(_ref) {
    ...
    return hasChildren ? React__default.createElement(
        'div',
    ...
    createClass(ToolbarDefaults, [{
        ...
        value: function render() {
            ...
            return [React__default.createElement(
                ToolbarGroup,
                { key: 'styles' },
                inlineStyles.filter(function (t) {
                    return !t.hideControl;
                }).map(function (t) {
                ...
                enableLineBreak ? React__default.createElement(ToolbarButton, {
                    name: BR_TYPE,
                    onClick: addBR,
                ...
                showRedoControl ? React__default.createElement(ToolbarButton, {
                    name: REDO_TYPE,
                    onClick: onUndoRedo,
...
var Toolbar = function Toolbar(props) {
    ...
    return React__default.createElement(
        ...
        React__default.createElement(ToolbarDefaults, props),
        React__default.createElement(
            ToolbarGroup,
            null,
...
var DividerBlock = function DividerBlock() {
  return React__default.createElement("hr", { className: "Draftail-DividerBlock" });
};
...
var DraftailEditor = function (_Component) {
    ...
    createClass(DraftailEditor, [{
        ...
        value: function handlePastedText(text, html, editorState) {
            var stripPastedStyles = this.props.stripPastedStyles;
        ...
        value: function render() {
            ...
            return React__default.createElement(
                ...
                this.renderSource(),
                React__default.createElement(draftjsConductor.ListNestingStyles, { max: maxListNesting })
            );
        }
    }]);
